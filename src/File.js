...
export const DEFAULT_DEPTH = 9
export const cloneWithDepth = (object, depth = DEFAULT_DEPTH) => {
...
const File = () => {
    const [data, setData] = useState(cloneWithDepth(result[0]))
    const [path, setPath] = useState([result[0].name])
    ...
    const findNode = (key, node = result[0], parentPath = []) => {
